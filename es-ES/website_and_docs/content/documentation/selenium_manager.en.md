...
This problem is the primary reason for the existence of the so-called _driver managers_ (such as [WebDriverManager](https://bonigarcia.dev/webdrivermanager/) for Java,
